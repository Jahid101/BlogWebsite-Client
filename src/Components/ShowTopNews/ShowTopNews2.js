...
import covid from '../../../src/images/covid.jpg';
...
const ShowTopNews2 = () => {
    ...
    return (
        <div>
            <div class="container">
                <img style={{ width: '100%', height: '70%' }} src={covid} alt="" />

                <h1 class="text-center">New Vaccine for Covid</h1>
